...
d_train = lgb.Dataset(X_selected, label=y)
...
y_pred_prob = model.predict(test_df_select, num_iteration=model.best_iteration)
...
# 指定輸出的 CSV 文件名稱
output_file = 'output/lightgbm select 180.csv'
